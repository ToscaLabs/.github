...
We tend to pay close attention to social problems for which computer science can
provide effective solutions, in the hope that our items can help others.

Our main project is a **versatile**, **customizable**, and **secure** IoT
framework called [tosca](https://github.com/ToscaLabs/tosca).  
Written in [Rust](https://rust-lang.org/), we guarantee memory and thread safety
...
Another one of our creations is [lich](https://github.com/ToscaLabs/lich),
an OS-based firmware analyzer designed to identify internal vulnerabilities and
extract energy consumption data. We have also developed this tool using the Rust
language.
...
Oh, and if you think your project might be a good fit for ToscaLabs, please
contacts us via the email address at the top of this page.
